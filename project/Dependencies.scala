...
object Dependencies {
  ...
  object Versions {
    ...
    val awsSdkV1Version     = "1.11.1001"
    val awsSdkV1DaxVersion  = "1.0.221844.0"
    val awsSdkV2Version     = "2.16.44"
  ...
  object akka {
    def actor(version: String)            = "com.typesafe.akka" %% "akka-actor"              % version
    def cluster(version: String)          = "com.typesafe.akka" %% "akka-cluster"            % version
    ...
    def multiNodeTestkit(version: String) = "com.typesafe.akka" %% "akka-multi-node-testkit" % version
