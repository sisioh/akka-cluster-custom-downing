...
class QuorumLeaderAutoDowningNodeThatIsUnreachableWithFailureDetectorPuppetMultiJvmNode1
    extends MultiNodeQuorumLeaderAutoDownSpec(MultiNodeQuorumLeaderAutoDownSpecConfig(failureDetectorPuppet = true))

class QuorumLeaderAutoDowningNodeThatIsUnreachableWithFailureDetectorPuppetMultiJvmNode2
    extends MultiNodeQuorumLeaderAutoDownSpec(MultiNodeQuorumLeaderAutoDownSpecConfig(failureDetectorPuppet = true))

class QuorumLeaderAutoDowningNodeThatIsUnreachableWithFailureDetectorPuppetMultiJvmNode3
    extends MultiNodeQuorumLeaderAutoDownSpec(MultiNodeQuorumLeaderAutoDownSpecConfig(failureDetectorPuppet = true))

class QuorumLeaderAutoDowningNodeThatIsUnreachableWithFailureDetectorPuppetMultiJvmNode4
    extends MultiNodeQuorumLeaderAutoDownSpec(MultiNodeQuorumLeaderAutoDownSpecConfig(failureDetectorPuppet = true))

class QuorumLeaderAutoDowningNodeThatIsUnreachableWithFailureDetectorPuppetMultiJvmNode5
    extends MultiNodeQuorumLeaderAutoDownSpec(MultiNodeQuorumLeaderAutoDownSpecConfig(failureDetectorPuppet = true))

class QuorumLeaderAutoDowningNodeThatIsUnreachableWithAccrualFailureDetectorMultiJvmNode1
    extends MultiNodeQuorumLeaderAutoDownSpec(MultiNodeQuorumLeaderAutoDownSpecConfig(failureDetectorPuppet = false))

class QuorumLeaderAutoDowningNodeThatIsUnreachableWithAccrualFailureDetectorMultiJvmNode2
    extends MultiNodeQuorumLeaderAutoDownSpec(MultiNodeQuorumLeaderAutoDownSpecConfig(failureDetectorPuppet = false))

class QuorumLeaderAutoDowningNodeThatIsUnreachableWithAccrualFailureDetectorMultiJvmNode3
    extends MultiNodeQuorumLeaderAutoDownSpec(MultiNodeQuorumLeaderAutoDownSpecConfig(failureDetectorPuppet = false))

class QuorumLeaderAutoDowningNodeThatIsUnreachableWithAccrualFailureDetectorMultiJvmNode4
    extends MultiNodeQuorumLeaderAutoDownSpec(MultiNodeQuorumLeaderAutoDownSpecConfig(failureDetectorPuppet = false))

class QuorumLeaderAutoDowningNodeThatIsUnreachableWithAccrualFailureDetectorMultiJvmNode5
    extends MultiNodeQuorumLeaderAutoDownSpec(MultiNodeQuorumLeaderAutoDownSpecConfig(failureDetectorPuppet = false))

abstract class MultiNodeQuorumLeaderAutoDownSpec(multiNodeConfig: MultiNodeQuorumLeaderAutoDownSpecConfig)
