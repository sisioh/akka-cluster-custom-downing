...
class RoleLeaderDowningNodeThatIsUnreachableWithFailureDetectorPuppetMultiJvmNode1
    extends MultiNodeRoleLeaderAutoDownRolesSpec(MultiNodeRoleLeaderDownRolesSpecConfig(failureDetectorPuppet = true))

class RoleLeaderDowningNodeThatIsUnreachableWithFailureDetectorPuppetMultiJvmNode2
    extends MultiNodeRoleLeaderAutoDownRolesSpec(MultiNodeRoleLeaderDownRolesSpecConfig(failureDetectorPuppet = true))

class RoleLeaderDowningNodeThatIsUnreachableWithFailureDetectorPuppetMultiJvmNode3
    extends MultiNodeRoleLeaderAutoDownRolesSpec(MultiNodeRoleLeaderDownRolesSpecConfig(failureDetectorPuppet = true))

class RoleLeaderDowningNodeThatIsUnreachableWithFailureDetectorPuppetMultiJvmNode4
    extends MultiNodeRoleLeaderAutoDownRolesSpec(MultiNodeRoleLeaderDownRolesSpecConfig(failureDetectorPuppet = true))

class RoleLeaderDowningNodeThatIsUnreachableWithFailureDetectorPuppetMultiJvmNode5
    extends MultiNodeRoleLeaderAutoDownRolesSpec(MultiNodeRoleLeaderDownRolesSpecConfig(failureDetectorPuppet = true))

class RoleLeaderDowningNodeThatIsUnreachableWithAccrualFailureDetectorMultiJvmNode1
    extends MultiNodeRoleLeaderAutoDownRolesSpec(MultiNodeRoleLeaderDownRolesSpecConfig(failureDetectorPuppet = false))

class RoleLeaderDowningNodeThatIsUnreachableWithAccrualFailureDetectorMultiJvmNode2
    extends MultiNodeRoleLeaderAutoDownRolesSpec(MultiNodeRoleLeaderDownRolesSpecConfig(failureDetectorPuppet = false))

class RoleLeaderDowningNodeThatIsUnreachableWithAccrualFailureDetectorMultiJvmNode3
    extends MultiNodeRoleLeaderAutoDownRolesSpec(MultiNodeRoleLeaderDownRolesSpecConfig(failureDetectorPuppet = false))

class RoleLeaderDowningNodeThatIsUnreachableWithAccrualFailureDetectorMultiJvmNode4
    extends MultiNodeRoleLeaderAutoDownRolesSpec(MultiNodeRoleLeaderDownRolesSpecConfig(failureDetectorPuppet = false))

class RoleLeaderDowningNodeThatIsUnreachableWithAccrualFailureDetectorMultiJvmNode5
    extends MultiNodeRoleLeaderAutoDownRolesSpec(MultiNodeRoleLeaderDownRolesSpecConfig(failureDetectorPuppet = false))

abstract class MultiNodeRoleLeaderAutoDownRolesSpec(multiNodeConfig: MultiNodeRoleLeaderDownRolesSpecConfig)
